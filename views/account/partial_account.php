            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 account-overview">
                ...
                <div class="row overview-row balances">
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        ...
                        <svg height="50" width="2" style="position:absolute;right:0;bottom:0;height:50%;z-index:1">
                            <line x1="0" y1="0" x2="0" y2="49" style="stroke:rgb(231,234,236);stroke-width:2" />
                        </svg>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        <div class="data-block">
